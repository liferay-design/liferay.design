...
import { Designer, IllustrationsCarousel, BrandCarousel } from 'pages/2018/components'
	...
	return <div className={styles.pagestyles}>
			...
			<Flex align="center" justify="center" direction="column" className={styles.tooSmall}>
				...
				<div className={styles.arrowA}>
					<svg viewBox="0 0 195 12" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<Plx className={styles.anchorLinks} parallaxData={anchorLinks}>
				<AnchorLink href="#top">
					<Plx className={styles.anchorBlock} parallaxData={anchorLinksBlocks} />
			...
			<section id="top" className={styles.banner}>
				...
				<div className={styles.backgroundElements}>
					...
					<Plx parallaxData={PlxRotateRight1} className={styles.biggestcircle}>
						<svg width="100%" height="100%" viewBox="0 0 850 850" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="50%" cy="50%" r="49%" stroke="#fff" stroke-width="1" stroke-dasharray="1, 10" />
						</svg>
					</Plx>
					...
					<Plx parallaxData={PlxRotateLeft1} className={styles.dashedcircle}>
						<svg width="100%" height="100%" viewBox="0 0 461 461" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="50%" cy="50%" r="49%" stroke="#006DE7" stroke-width="4" stroke-dasharray="1, 10" />
						</svg>
					</Plx>
					<div className={styles.circle}>
						<svg width="100%" height="100%" viewBox="0 0 850 850" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="50%" cy="50%" r="49.4%" stroke="#006DE7" stroke-width="12" />
						</svg>
					</div>
					<Plx parallaxData={bannerPie} className={styles.pie}>
						<svg width="100%" height="100%" viewBox="0 0 438 457" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M0 438.5C0 196.49 196.053.27 438 0v457H.383A446.101 446.101 0 0 1 0 438.5z" fill="#000" />
						</svg>
					</Plx>
				</div>
			</section>
			...
			<section id="team" className={styles.team}>
				<Plx parallaxData={PlxRotateUp1} className={styles.circle}>
					<svg width="100%" height="100%" viewBox="0 0 461 461" fill="none" xmlns="http://www.w3.org/2000/svg">
						<circle cx="50%" cy="50%" r="48%" stroke="#006DE7" stroke-width="4" stroke-linejoin="round" stroke-dasharray="1 10" />
					</svg>
				</Plx>
			...
			<section id="products-launched" className={styles.productsLaunched}>
				...
				<Plx parallaxData={PlxRotateUp1} className={styles.biggestcircle}>
					<svg width="100%" height="100%" viewBox="0 0 850 850" fill="none" xmlns="http://www.w3.org/2000/svg">
						<circle cx="50%" cy="50%" r="50%" stroke="#fff" stroke-width="0.5" stroke-dasharray="0.5, 5" />
					</svg>
				</Plx>
			</section>
					...
					<Flex justify="center" align="center" className={styles.blackWaffle}>
						<Plx parallaxData={PlxUp1}>
							<svg width="100%" height="100%" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M23 27a4 4 0 0 1 4-4h46a4 4 0 0 1 4 4v46a4 4 0 0 1-4 4H27a4 4 0 0 1-4-4V27zm8 5a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6zm11-1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-6zm9 1a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6zm-19 9a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-6zm9 1a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6zm21-1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-6zM31 52a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6zm21-1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-6zm9 1a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6zm-19 9a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-6zm9 1a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6zm11-1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-6z" fill="#fff" />
							</svg>
						</Plx>
					</Flex>
			...
			<section id="redefined" className={styles.redefined}>
				...
				<p className={styles.p}>
					...
					variety of departments and regions. Then we conducted an offsite
					brand sprint with the CEO and marketing leadership to gather data
					for Liferay’s long-term vision.
				</p>
				<BrandCarousel />
			</section>
			...
			<section id="designers-hired" className={styles.designersHired}>
				...
				<Flex direction="column" justify="space-between" className={styles.timeline}>
					...
					<Designer profileUrl="/team/bargaid-duuriimaa" month="Feb" day="08" headshot="/images/headshots/bargaid-duuriimaa.jpg" name="Duuriimaa" detail="firstDay" country="Spain" />
					<Designer profileUrl="/team/connolly-ryan" month="Apr" day="24" headshot="/images/headshots/connolly-ryan.jpg" name="Ryan" detail="birthRay" birthRay />
					<Designer profileUrl="" month="May" day="07" headshot="/images/headshots/-sunglasses.png" name="Andras" detail="firstDay" country="Hungary" />
					<Designer profileUrl="" month="May" day="14" headshot="/images/headshots/-heart-eyes-cat.png" name="Andrea" detail="firstDay" country="Italy" />
					<Designer profileUrl="" month="Jul" day="03" headshot="/images/headshots/oliveira-cassia.jpg" name="Cassia" detail="birthRay" country="" birthRay />
					<Designer profileUrl="/team/pentz-patrick" month="Aug" day="07" headshot="/images/headshots/pentz-patrick.jpg" name="Patrick" detail="birthRay" country="" birthRay />
					<Designer profileUrl="/team/lyons-james" month="Sep" day="10" headshot="/images/headshots/lyons-james.jpg" name="James" detail="firstDay" country="California" />
					<Designer profileUrl="" month="Sep" day="11" headshot="/images/headshots/-upside-down-face.png" name="Gabryelle" detail="birthRay" country="Brazil" birthRay />
					<Designer profileUrl="/team/kim-david" month="Sep" day="17" headshot="/images/headshots/kim-david.jpg" name="David" detail="firstDay" country="California" />
					<Designer profileUrl="" month="Sep" day="18" headshot="/images/headshots/shama-davi.jpg" name="Davi" detail="birthRay" country="" birthRay/>
					<Designer profileUrl="/team/manso-miriam" month="Oct" day="15" headshot="/images/headshots/manso-miriam.jpg" name="Miriam" detail="firstDay" country="Spain" />
					<Designer profileUrl="" month="Oct" day="02" headshot="/images/headshots/fernandes-rafael.jpg" name="Rafael" detail="birthRay" country="" birthRay/>
					<Designer profileUrl="/team/jeong-chris" month="Oct" day="16" headshot="/images/headshots/jeong-chris.jpg" name="Chris" detail="birthRay" country="" birthRay/>
					<Designer profileUrl="/team/vazquez-susana" month="Oct" day="18" headshot="/images/headshots/vazquez-susana.jpg" name="Susana" detail="birthRay" country="" birthRay/>
					<Designer profileUrl="/team/hancock-abel" month="Dec" day="18" headshot="/images/headshots/hancock-abel.jpg" name="Abel" detail="birthRay" country="" birthRay/>
				</Flex>
			</section>
			...
			<section id="dribbble" className={styles.dribbble}>
				...
				<Plx className={styles.p} parallaxData={PlxUp1}>
					A 6-week daily posting regimen coordinated between all three regions created significant results on the primary social media platform for designers.
				</Plx>
			...
			<section id="lexicon" className={styles.lexicon}>
				...
				<p className={styles.p}>
					Our Design System evolved into <a href="https://lexicondesign.io/" target="_new">
						version 2.0
					</a> and was spread to different products and projects.
				</p>
				<p className={styles.p}>
					Utilizing Lexicon in more interfaces allow us to gain robustness
					and improve communication through a consistent language.
				</p>
				<div className={styles.wrapper}>
					...
					<Plx parallaxData={PlxUp3} className={styles.grid}>
						...
						<Flex justify="center" align="center" direction="column" className={styles.projects}>
			...
			<section id="thankyou" className={styles.thankyou}>
				...
				<p className={styles.p}>
					...
					something tangible. I want to applaud the efforts of the entire
					team and thank everyone at Liferay for being so understanding and
					accepting of our push to establish strong design-thinking at this
					company. We’re excited to do even more next year. Paul is a
					disappointment, though. Thank you all.
				</p>

				<Plx parallaxData={PlxUp2} className={styles.p}>
					Juan Hidalgo
					<Plx parallaxData={PlxUp3} tagName="img" src="/images/2018/jh-signature-hwite.png" className={styles.signature} />
					<img src="/images/headshots/hidalgo-juan.jpg" className={styles.headshot} />
				</Plx>
			</section>
