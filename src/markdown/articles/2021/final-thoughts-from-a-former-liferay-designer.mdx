...
title: Some Parting Thoughts
featuredImage: /images/articles/bye-pj.jpg
publish: true
---

import { Heading } from 'theme-ui'

_It’s always a bittersweet moment when a Liferay Designer decides to move on to a new opportunity. PJ is no exception. We’ve watched PJ grow from a young starling to a seasoned designer with a promising trajectory. Before we say goodbye to our colleague and friend, we offered PJ the chance to leave a few parting remarks about his journey. Join me in taking a moment to hear a little bit about PJ’s path and some final bits of wisdom._

_— [Ryan Connolly](/team/connolly-ryan)_
