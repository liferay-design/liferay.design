...
<Image src="/images/posts/2019-evp/intro-tech-stack.png" rounded size="small" align="right" margin="2rem 0 0 2rem" caption='Drake says "Dropbox is so 2017"' />
...
<div style="float:right; width:180px;">
    <Image src="/images/posts/2019-evp/intro-logo.png" rounded align="right" margin="2rem 0 2rem 2rem" caption="The Underground Writing logo" />
</div>
...
<Image src="/images/posts/2019-evp/intro-website.jpg" margin="2rem 0" caption="Undergroundwriting.org before we began the project." size="large" />
...
<div style="width:102%;margin-left:-1%;">
    <Grid templateColumns="3rem 1fr 3rem 1fr" autoRows="auto" gap="1rem">
        ...
        <Grid.Item>
            ...
            <Text>In addition to dentistry, branding is one of Ryan’s passions. He has been prevented from practicing the former by numerous medical boards, thankfully he has diverted his energy to the latter. His agency background really shines when he gets his hands on a raw, new brand.</Text>
        </Grid.Item>
        <Grid.Item>
