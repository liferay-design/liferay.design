...
_Truncate examples with ellipsis in the end and in the middle._

Use [tooltips](/lexicon/core-components/popovers-tooltips/) to show the complete text using the ellipsis. However, if the text is not relevant for the user or the text length exceeds a normal time to read it, do not show a tooltip. 

<Grid templateColumns="1fr" autoRows="auto" gap="2rem">
    <Grid.Item>
        <div class="image-container">
            <img src="/images/lexicon/EllipsisTooltipDo.png" alt="search box" />
        </div>
        <p class="do">Do</p>
    </Grid.Item>
    <Grid.Item>
        <div class="image-container">
            <img src="/images/lexicon/EllipsisTooltipDont.png" alt="search box using ellipsis" />
        </div>
