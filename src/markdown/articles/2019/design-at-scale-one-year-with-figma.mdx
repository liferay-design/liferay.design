...
By 2017, we had a few designers using it for most of their work, and one of the [Lexicon designers](https://twitter.com/emilianogcicero) ([Liferay’s design system](https://liferay.design/lexicon)), Emiliano Cicero, was quickly becoming an evangelist — which turned out to be a key factor in convincing the rest of the team to make the switch.
