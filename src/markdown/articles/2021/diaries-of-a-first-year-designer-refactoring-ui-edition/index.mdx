...
title: 'Diaries of a First Year Designer - Refactoring UI Edition'
...
_I recently transitioned from a career in architecture into the world of software product design. As someone who is more used to doing technical drawings, I’ve become hyper-aware that my eyes lack the training required to articulate what makes a user interface beautiful and useful. As a way to bridge this gap, I read “Refactoring UI'', from Adam Wathan and Steve Shoger's,  and started training myself to notice these things and putting it to practice at my workplace. If you are just starting out like me, here are some lessons that (I think) have made me a better designer._
...
<p style="text-align: center; font-size: 1rem; font-style: italic; color: #6b6c7e; margin-bottom: 2rem">Hierarchy - Content Performancee Liferay DXP</p>
...
<p style="text-align: center; font-size: 1rem; font-style: italic; color: #6b6c7e; margin-bottom: 2rem">The color and type pairing makes this design lighthearted while maintaining a formal sensibility with it’s sharp edges.</p>
...
[Liferay DXP](https://www.liferay.com/pt/products/dxp)

[Liferay Commerce](https://www.liferay.com/pt/products/commerce)