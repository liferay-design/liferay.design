...
<Image src="/images/handbook/principles-good-design-is-group.jpg" align="right" size="small" caption="PJ sharing one group's ideas during the Principles&nbsp;exercise" margin="2rem -2rem 0 4rem" rounded dropShadow />
...
<aside>...a shared framework so we can make better&nbsp;decisions together, faster.</aside>
...
<Image src="/images/handbook/principles-closeup.jpg" align="right" size="small" margin="1rem -2rem 0 4rem" rounded dropShadow />
...
<Image src="/images/handbook/principles-team-photo.gif" size="medium" caption="Inclusive, intentional, honest, and pleasurable." margin="4rem auto" rounded dropShadow />