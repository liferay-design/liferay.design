...
featuredImage: '/images/articles/building-an-enterprise-website/liferay.com.png'
publish: true
---
...
<Image
    ...
    caption={<span>Design system components for liferay.com created in Figma and documented on <a href="https://style.liferay.design">style.liferay.design</a>.</span>}
    size="large"
    align="left"
	margin="2rem 0 4rem"
    dropShadow
...
<figcaption style="color: rgb(107, 108, 126); font-style: italic; text-align: center; margin-bottom: 2rem;">A live recording of a business user building and publishing <a href="http://liferay.com/services/consulting">liferay.com/services/consulting</a></figcaption>
...
<table style="box-shadow: rgba(48, 49, 63, 0.16) 0px 0.5rem 8rem -0.5rem; border-radius: 8px; margin: 2rem 0 0;">
    <thead>
        <tr>
            <th>2018</th>
            <th>2019</th>
    ...
    <tbody>
        <tr>
            <td>7 developers</td>
            <td>2 developers (+3 for 1 week)</td>
            <td>2 developers</td>
        </tr>
        <tr>
            <td>3 designers</td>
        ...
        <tr>
            <td>100+ hours overtime</td>
            <td>~32 hours overtime</td>
            <td>0 hours overtime</td>
        </tr>
    </tbody>
</table>


<figcaption style="color: rgb(107, 108, 126); font-style: italic; text-align: center; margin-bottom: 2rem;"><a href="https://liferay.design/articles/2019/increasing-our-ability-to-convert-prospects">A comparison</a> of effort required for annual product releases.</figcaption>
