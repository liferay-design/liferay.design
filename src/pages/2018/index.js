		...
		<div className={styles.pagestyles}>
			...
			<section id="designers-hired" className={styles.designersHired}>
				...
				>
					...
					<Designer
						...
						month="Feb"
						day="08"
						headshot="/images/headshots/bargaid-duuriimaa.jpg"
						name="Duuriimaa"
						detail="firstDay"
						country="Spain"
					/>
					...
					<Designer
						...
						month="May"
						day="07"
						headshot="/images/headshots/-sunglasses.png"
						name="Andras"
						detail="firstDay"
						country="Hungary"
					/>
					<Designer
						...
						month="May"
						day="14"
						headshot="/images/headshots/-heart-eyes-cat.png"
						name="Andrea"
						detail="firstDay"
						country="Italy"
					/>
					<Designer
						...
						month="Jul"
						day="03"
						headshot="/images/headshots/oliveira-cassia.jpg"
						name="Cassia"
						detail="birthRay"
						country=""
						birthRay
					...
					<Designer
						...
						month="Aug"
						day="07"
						headshot="/images/headshots/pentz-patrick.jpg"
						name="Patrick"
						detail="birthRay"
						country=""
						birthRay
					...
					<Designer
						...
						month="Sep"
						day="18"
						headshot="/images/headshots/shama-davi.jpg"
						name="Davi"
						detail="birthRay"
						country=""
						birthRay
					...
					<Designer
						...
						month="Oct"
						day="02"
						headshot="/images/headshots/fernandes-rafael.jpg"
						name="Rafael"
						detail="birthRay"
						country=""
						birthRay
					...
					<Designer
						...
						month="Oct"
						day="16"
						headshot="/images/headshots/jeong-chris.jpg"
						name="Chris"
						detail="birthRay"
						country=""
						birthRay
			...
			<section id="vanity-metrics" className={styles.stats} scroll="no">
				...
				<Plx className={styles.grid}>
					...
					<VanityMetric number="06" description="Events Hosted" size="40%" />
					<VanityMetric number="18" description="Events Attended" size="60%" />
					<VanityMetric number="12" description="Talks Given" size="50%" />
					<VanityMetric number="849" description="Applications" size="110%" />
					<VanityMetric number="33" description="Interviews" size="70%" />
					<VanityMetric number="06" description="New Hires" size="40%" />
					<VanityMetric
						number="4.5k"
						description="Documents Created"
						size="140%"
					/>
					<VanityMetric number="205" description="Icons Created" size="95%" />
					<VanityMetric number="23" description="Loop Posts" size="65%" />
					<VanityMetric
						number="112"
