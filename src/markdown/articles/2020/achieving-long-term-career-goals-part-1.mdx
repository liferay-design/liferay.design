...
featuredImage: '/images/articles/joncast.png'
publish: true
---
...
> At the end of the day, design is about problem solving. It's about solving the problems as specifically and as effectively as possible. If these tools or frameworks enable that to make that much of a difference, then OK, maybe look into it. But if it's just like sexy marketing, you really need to evaluate how this is going to contribute to your actual growth.
