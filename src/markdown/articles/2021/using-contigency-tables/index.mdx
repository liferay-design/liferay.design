...
<p style="text-align: center; font-size: 1rem; font-style: italic; color: #6b6c7e; margin-bottom: 2rem">Dual Listbox Version 1 (left) and Version 2 (right)</p>
...
<p style="text-align: center; font-size: 1rem; font-style: italic; color: #6b6c7e; margin-bottom: 2rem">Test environment. Figma interactive mockups. Version 1 - environment A (left), Version 2 -environment B (right)</p>
