...
| Size                                                            | Usage                                                                                                                 |
| --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| ![default label small size](/images/lexicon/LabelSmall.png)     | **Small**: Use the small label when the label doesn’t need emphasis. Always use uppercase text for the small label.   |
| ![default label default size](/images/lexicon/LabelDefault.png) | **Default**: Use the default size to mark states. The use of lowercase is acceptable for this size.                   |
