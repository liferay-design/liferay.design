...
<Image rounded dropShadow margin="4rem auto" caption="Markus, PJ, and Susana can access all files in all projects, Corbin can see all files in the Lexicon project, Henry can only see lrdc-1" src="/images/handbook/tools/figma/figma-permissions.png"  />
...
<Image align="right" rounded dropShadow size="small" src="/images/handbook/tools/figma/save-as-fig.png" margin="0 0 0 4rem" />
...
<Image rounded dropShadow margin="4rem auto" src="/images/handbook/tools/figma/figma-covers.png" />
