...
<p style="text-align: center; font-size: 1rem; font-style: italic; color: #6b6c7e; margin-bottom: 2rem">Old inputs vs new styles configuration</p>
...
<p style="text-align: center; font-size: 1rem; font-style: italic; color: #6b6c7e; margin-bottom: 2rem">Fragments custom CSS and CSS extensions</p>
...
<p style="text-align: center; font-size: 1rem; font-style: italic; color: #6b6c7e; margin-bottom: 2rem">Fragments ordering feature</p>
...
<p style="text-align: center; font-size: 1rem; font-style: italic; color: #6b6c7e; margin-bottom: 2rem">New two sidepanel layout for page builder</p>
