...
description: 'A step-by-step guide to creating a Design Request in Jira'
order: 1
publish: true
---
...
Each request requires its own ticket. For example, if you have three whitepapers you are requesting, create one ticket per paper. This will keep communication and feedback clear for each one. If you want to organize these tickets under one bigger project, create a Parent Ticket first, and then a corresponding Subtask for each paper:

*   Parent Ticket: _Whitepapers for New Customers_
    *   Subtask: _Title of Paper 1_
    *   Subtask: _Title of Paper 2_
    *   Subtask: _Title of Paper 3_
...
Select the project from the dropdown that best categorizes your request. Some location-, campaign-, and events-based components already exist. Create a new component, if necessary.
...
<Button sx={{my:5}} href='https://issues.liferay.com/secure/CreateIssueDetails!init.jspa?pid=10780&issuetype=17'>Create a Design Request</Button>