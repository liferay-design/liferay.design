...
heroImage: '/images/events/figma-barcelona-banner.png'
...
_Friends of Figma Barcelona hosted the event — this is amazing because they are a very active community which we wouldn't have had the opportunity to work with if it weren't for the current situation. — It seems now it’s time for remote events._

## The hosts

[Friends of Figma Barcelona](http://friends.figma.com/barcelona/) is a community created in 2021 led by [Iban Curdu](http://twitter.com/ibancurdu) and [Carmen Ansio](http://twitter.com/carmenansio). They are friendly and very approachable and made us feel comfortable talking with them during the event. 
