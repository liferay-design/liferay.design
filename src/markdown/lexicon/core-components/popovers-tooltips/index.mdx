...
![four different popovers with the arrow to the left, or right or top or down](./popover-tooltip-1.png)
...
![help icon](./popover-tooltip-2.png)
...
![Two examples of tooltips. The first one has an extensive description of an Application. The second one says "Add Template".](./popover-tooltip-8.png)

### Positions
Tooltips arrows can be placed in 9 different positions:

![Nine tooltips with their position name within.](./popover-tooltip-9.png)
