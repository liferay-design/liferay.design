...
<Grid columns="repeat( auto-fit, minmax(200px, 1fr) )" autoRows="auto" gap="1rem">
    <AssetCard title="Default Cover" preview="/images/templates/thumbnails/doc-default.png" link="https://fonts.google.com/specimen/Source+Sans+Pro"/>
	<AssetCard title="Document Sans Cover" preview="/images/templates/thumbnails/doc-coverless.png" link="https://fonts.google.com/specimen/Source+Han+Sans"/>
	<AssetCard title="Letterhead" preview="/images/templates/thumbnails/doc-letterhead.png" link="https://fonts.google.com/specimen/Source+Han+Sans"/>
	<AssetCard title="Training" preview="/images/templates/thumbnails/doc-training.png" link="https://fonts.google.com/specimen/Source+Han+Sans"/>
</Grid>
