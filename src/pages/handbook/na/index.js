...
export default ({ data }) => {
	return <div className={styles.body}>
			<Banner headline="Handbook" subtitle="For UX Design in North America" cta="Get Started" ctaLink="/handbook/na/onboarding" section="Handbook" background="url(/images/diamond-bar-topography.png) center / cover fixed, #13141f" />
