...
*   Issue Type: Communication Design Request
...
Jira allows any user to secure the issues by limiting their visibility to certain users, groups and roles. There is a possibility to set up several different security levels linked to different permissions. [You can read more about this topic here.](/../../handbook/tools/jira/security/)
