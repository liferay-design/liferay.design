...
| ![checkbox Indeterminate](/images/lexicon/CheckboxMultiple.jpg)        | Indeterminate, variable for multiple selection |
| ![checkbox Indeterminate](/images/lexicon/CheckboxMultipleDisabled.jpg)| Indeterminate disabled                         |

### Checkbox group

Checkboxes are commonly grouped in forms to provide a set of options.

![checkbox list](/images/lexicon/CheckboxList.jpg)
...
![radio list](/images/lexicon/RadioList.jpg)
