    ...
    <div className={styles.pagestyles}>
        ...
        <Plx
            ...
            parallaxData={ anchorLinks }>
                ...
                <AnchorLink href='#designers-hired'>
                    <Plx className={styles.anchorBlock} parallaxData={anchorLinksBlocks}></Plx>
                    <Plx className={styles.anchorText} parallaxData={anchorLinksText} >Big Moments</Plx>
                </AnchorLink>
        ...
        <section id="designers-hired" className={styles.designersHired}>
            ...
            <Flex direction="column" justify="space-between" className={styles.timeline}>
                ...
                <Plx tagName="a" href="team/bargaid-duuriimaa" parallaxData={ designerHired } className={styles.hired}>
                    <div className={styles.date}>
                        <div className={styles.pLarge}>Feb</div>
                        <div className={styles.f1}>08</div>
                    </div>
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/bargaid-duuriimaa.jpg" />
                    <h4 className={styles.pLarge}>Duuriimaa Bargaid <span>&nbsp;&nbsp; Spain</span></h4>
                </Plx>

                <Plx tagName="a" href="team/connolly-ryan" parallaxData={ designerHired } className={styles.birthray}>
                    <div className={styles.date}>
                        <div className={styles.pLarge}>Apr</div>
                        <div className={styles.pLarge}>24</div>
                    </div>
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/connolly-ryan.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.hired}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/-sunglasses.png" />
                ...
                <Plx parallaxData={ designerHired } className={styles.hired}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/-heart-eyes-cat.png" />
                ...
                <Plx parallaxData={ designerHired } className={styles.birthray}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/oliveira-cassia.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.birthray}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/pentz-patrick.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.hired}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/lyons-james.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.birthray}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/-upside-down-face.png" />
                ...
                <Plx parallaxData={ designerHired } className={styles.hired}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/kim-david.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.birthray}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/shama-davi.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.hired}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/manso-miriam.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.birthray}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/jeong-chris.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.birthray}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/vazquez-susana.jpg" />
                ...
                <Plx parallaxData={ designerHired } className={styles.birthray}>
                    ...
                    <Plx tagName="img" parallaxData={ designerHeadshot } className={styles.designerHeadshot} src="images/headshots/hancock-abel.jpg" />
        ...
        <section id="lexicon" className={styles.lexicon}>
            ...
            <div className={styles.wrapper}>
                <div className={styles.lexiconBackground}>
                    <div className={styles.justblue}></div>
                    <div className={styles.svgpattern}></div>
                </div>
                <Plx parallaxData={ PlxUp3 } className={styles.grid}>
                    ...
                    <div className={styles.snapshot}></div>
                </Plx>
            </div>
        </section>
        ...
        <section id="thankyou" className={styles.thankyou}>
            ...
            <p className={styles.p}>Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vivamus suscipit tortor eget felis porttitor volutpat. Sed porttitor lectus nibh. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula.

            Nulla porttitor accumsan tincidunt. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. Donec rutrum congue leo eget malesuada. Sed porttitor lectus nibh.</p>
            <Plx parallaxData={ PlxUp2 } className={styles.p}>Juan Hidalgo
            <Plx parallaxData={ PlxUp1} tagName="img" src="images/2018/jh-signature-hwite.png"/>
            </Plx>
